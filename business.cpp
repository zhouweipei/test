...
QString Business::password() const
{
    return business_password;
}
void Business::addBusiness(QString name,QString password,QString image, QString info)
{
    business_name=name;
    ...
    add_businessquery.exec("create table businessdata (businessname varchar(20) ,business_password varchar(20),business_info varchar(50),business_image varchar(50))");
    add_businessquery.prepare("insert into businessdata (businessname,business_password,business_info,business_image) values(?,?,?,?)");
    add_businessquery.addBindValue(business_name);
    add_businessquery.addBindValue(business_password);
